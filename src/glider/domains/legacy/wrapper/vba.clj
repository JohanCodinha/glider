(ns glider.domains.legacy.wrapper.vba
  (:require [clj-http.client :refer [request] :as http]
            ...
            [glider.domains.legacy.wrapper.utils :refer [login-required? page-stream]]
            [glider.domains.legacy.wrapper.login :refer
             [get-user-details login->cookie]]
            [glider.domains.legacy.wrapper.general-obs :refer [get-user-general-obs]]))
...
#_(defn get-species-by-survey-id [id]
  (let [cookies (login->cookie "username" "password")
